...
import manifest from '@museumwnf/arts-in-dialogue-data'
import partnerNamesEn from '@museumwnf/arts-in-dialogue-data/translations/partners.en.json'
import dynastyNamesEn from '@museumwnf/arts-in-dialogue-data/translations/dynasties.en.json'
...
describe('website smoke test', () => {
  ...
  it('renders the shared texts and its own over them', async () => {
    ...
    expect(checkTextsRendered(host, {
      namespaces: ['artsInDialogue', 'core', 'layout', 'catalogue', 'record', 'sheet', 'timeline', 'partner', 'exhibition'],
    })).toEqual([])
