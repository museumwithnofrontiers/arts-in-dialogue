...
The **Museum With No Frontiers — Arts in Dialogue** exhibition, built from the published
dataset `@museumwnf/arts-in-dialogue-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/arts-in-dialogue-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/arts-in-dialogue/> through the reusable workflows in
