...
// (`npm pack @museumwnf/arts-in-dialogue-data`) — never the legacy project
...
export const projectColors = {
  '08eff25c-24af-5d7d-8635-18ea15aca879': 'exhibition', // The Use Of Colours In Art (this exhibition's own project, or borrowed from another exhibition — shares the 'exhibition' family)
  ...
  '21cccf03-49f5-55d3-96f5-eddeee7a989d': 'exhibition', // Water in Islam (this exhibition's own project, or borrowed from another exhibition — shares the 'exhibition' family)
  ...
  'a76657a2-5a19-523f-ae2d-a3dd8a5ff4bd': 'exhibition', // Arts in Dialogue (this exhibition's own project, or borrowed from another exhibition — shares the 'exhibition' family)
}
...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'Arts in Dialogue',
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/arts-in-dialogue' },
  ...
  extraViews: [
    ...
    ...standardRoutes('exhibition', {
      partnerObjects: {
        emptyPartner: 'artsInDialogue.partnerObjects.emptyPartner',
        emptyInstitution: 'artsInDialogue.partnerObjects.emptyInstitution',
        institutionSummary: 'artsInDialogue.partner.monumentsInExhibition',
        partnerProfileLabel: 'artsInDialogue.partnerObjects.partnerProfile',
        institutionProfileLabel: 'artsInDialogue.partnerObjects.institutionProfile',
      },
    }),
