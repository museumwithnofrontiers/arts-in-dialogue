...
const about = {
  body: 'artsInDialogue.about.body',
...
export default {
  ...
  home: {
    title: 'artsInDialogue.identity.title',
    intro: 'artsInDialogue.home.intro',
    cards: [
      {
        title: 'artsInDialogue.nav.catalogue',
        description: 'artsInDialogue.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'artsInDialogue.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'artsInDialogue.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'artsInDialogue.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'artsInDialogue.credits.body' }),
